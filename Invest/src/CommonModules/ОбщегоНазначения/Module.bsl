...
// Функция ПолучитьЗначениеКонстанты возвращает значение константы,
// 
//  Если доступа к одному из реквизитов нет, возникнет исключение прав доступа.
//  Если необходимо зачитать реквизит независимо от прав текущего пользователя,
//  то следует использовать предварительный переход в привилегированный режим.
// 
// Параметры:
//  ИмяКонстанты - Строка, константы.
// 
// Возвращаемое значение:
//  Значение    -  значение константы.
//
Функция ПолучитьЗначениеКонстанты(ИмяКонстанты) Экспорт
//++OW Копачев А.С. 07.10.2019 ONEC-4349 	
...
//
Функция МассивВТаблицуЗначений(мсДанные) Экспорт
...
Функция ПреобразоватьМассивВСтроку(Массив,Разделитель = "")Экспорт
	...
	Возврат Лев(СтрокаРезультат, СтрДлина(СтрокаРезультат)-СтрДлина(Разделитель));
	//- Пилюгин В.Е. 18.10.2017
КонецФункции 
...
// Функция-свойство: возвращает значение для идентификации общего типа "РегламентныеЗадания"
//
// Тип: Строка
//
Функция ИмяТипаРегламентныеЗадания() Экспорт
	//++OW Копачев А.С. 24.12.2019 ONEC-5125	
	Возврат "РегламентныеЗадания";
	//--OW Копачев А.С. 24.12.2019 ONEC-5125	
КонецФункции

// Функция-свойство: возвращает значение для идентификации общего типа "Перечисления"
//
// Тип: Строка
//
...
Функция ПометкаНаУдаление(ОбъектСсылка) Экспорт
	//+ Пилюгин В.Е. 21.02.2018
	Если ЗначениеСсылочногоТипа(ОбъектСсылка) Тогда
...
////////////////////////////////////////////////////////////////////////////////
// Вспомогательные функции для работы с параметрами отчетов СКД.

Функция ПолучитьПользовательскийПараметрСКД(ИмяПараметра, КомпоновщикНастроек) Экспорт
    ...
    Если НайденныйПараметрВарианта <> Неопределено Тогда
        ...
        НайденныйПараметр = ПолучитьПредопределенныйЭлементПользовательскихНастроекСКД(НайденныйПараметрВарианта, КомпоновщикНастроек.ПользовательскиеНастройки);
...
Функция ПолучитьПредопределенныйЭлементПользовательскихНастроекСКД(ЭлементНастроекВарианта, ПользовательскиеНастройки) Экспорт
